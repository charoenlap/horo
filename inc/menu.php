                            ...
                            <ul class="cd-dropdown-content">
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="cd-secondary-dropdown is-hidden">
                                        ...
                                        <!-- .has-children -->
                                        <li>
                                            <a href="chinese_single.php">Chinese-Single</a>
                                        </li>
                                        <!-- .has-children -->
                                        <li>
                                        ...
                                        <!-- .has-children -->
                                        <li>
                                            <a href="kundli_dosh.php">Kundli-Dosh</a>
                                        </li>
                                        <!-- .has-children -->
                                        <li>
                                        ...
                                        <!-- .has-children -->
                                        <li>
                                            <a href="tarot_single.php">Tarot-Single</a>
                                        </li>
                                        <!-- .has-children -->
                                        <li>
                                            <a href="vastu_shastra.php">Vastu-Shastra</a>
                                        </li>
                                        <!-- .has-children -->
                                    </ul>
                                    <!-- .cd-secondary-dropdown -->
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="cd-secondary-dropdown is-hidden">
                                        ...
                                        <!-- .has-children -->
                                        <li>
                                            <a href="shop_single.php">Shop-Single</a>
                                        </li>
                                        <!-- .has-children -->
                                    </ul>
                                    <!-- .cd-secondary-dropdown -->
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="cd-secondary-dropdown is-hidden">
                                        <li class="go-back"><a href="#0">Menu</a></li>
                                        <li>
                                            <a href="blog_categories.php">Blog-Categories</a>
                                        </li>
                                        <!-- .has-children -->
                                        <li>
                                            <a href="blog_single.php">Blog-Single</a>
                                        </li>
                                        <!-- .has-children -->
                                    </ul>
                                    <!-- .cd-secondary-dropdown -->
                                ...
                                <li><a href="contact.php" class="hs_btn_hover">Appointments</a></li>
                            </ul>
                            <!-- .cd-dropdown-content -->
                        </nav>
                        <!-- .cd-dropdown -->
